...
```
If you encounter any issues regarding setting up the simulation, feel free to send an email to create an issue.
...
#Use apn name "oai"
```
If you encounter any issues regarding setting up over-the-air mode, feel free to send an email to create an issue.
