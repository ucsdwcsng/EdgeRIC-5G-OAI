...
```
If you encounter any issues regarding setting up the simulation, feel free to create an issue.
...
#Use apn name "oai"
```
If you encounter any issues regarding setting up over-the-air mode, feel free to create an issue.
